...
- 作業ブランチは `main`、追跡先は `origin/main`。今回の開始時点は `4393259` で同期済み、マージ作業なし。
...
- 表・電卓・履歴テスト: `node --test scripts/calculator.test.cjs`（今回19件成功。PCの表1:右側2の列幅比、D/@の下端揃え、Dの拡大、@の上方向微調整も検証）
